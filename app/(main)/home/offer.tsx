...
export const Offer = () => {
  return (
    <section className="py-12 sm:py-24 lg:py-10 bg-indigo-700 dark:bg-indigo-900 px-3 md:px-10 lg:px-24 ">
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col xl:flex-row justify-between xl:space-x-24 space-y-12 xl:space-y-0">
          <div className="text-center space-y-6 shadow-xl rounded-md p-8 bg-white dark:bg-neutral-900">
          ...
          <div className="text-center space-y-6 shadow-xl rounded-md p-8 bg-white dark:bg-neutral-900">
            ...
            <p className="text-md max-w-[350px] m-auto">
              Kod nas nema skrivenih troškova. Sve informacije o cijenama i
              uvjetima najma jasno su navedene od samog početka, što vam
