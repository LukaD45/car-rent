    ...
    <section>
      <div className="p-1 md:p-10 md:flex items-center  justify-around">
        ...
        <div className="flex md:w-5/12 flex-col p-6 space-y-10 leading-7 justify-start">
          ...
          <p>
            Dobrodošli u Rent, gdje vaša udobnost i sigurnost dolaze na prvo
            mjesto! Nudimo širok izbor vozila koja će zadovoljiti sve vaše
            potrebe, bilo da planirate poslovno putovanje, obiteljski odmor, ili
